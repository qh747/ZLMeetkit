...
两人专属房间，自动限制最多两人；支持画中画拖动、聊天与单独录制。

<p align="center">
  <img src="./docs/images/1v1通话.svg" alt="1v1 通话" width="32%" />
  &nbsp;
  <img src="./docs/images/1v1通话-聊天.svg" alt="1v1 通话 — 聊天" width="32%" />
  &nbsp;
  <img src="./docs/images/1v1通话-录制.svg" alt="1v1 通话 — 录制" width="32%" />
</p>
